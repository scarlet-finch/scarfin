...
const print_help = (exit_code = 0) => {
    const usage = `scarfin serve -- <image files or folders>
    ex: scarfin serve -- ~/scarfin-library`;
    ...
    Scarfin provides a webserver as a UI to help with tasks like managing
    tags, etc. Typically, you point this to either your photos storage, or
    one of the location where scarfin has mounted the images.
    ...
    run 'scarfin serve --help' to see complete help.
    `;
    if (exit_code === 0) {
        console.log(help);
    } else {
